public class Netzwerk {
	...
	/**
	 * Diese Methode soll das Netzwerk starten. Dazu wird zuerst in einem Thread
	 * der Server gestartet und dann in jeweils einem eigenen Thread die beiden
	 * Clients, die sich an den Server anmelden. Bisher noch mit eigener Main
	 * Klasse. Dies ist nur zu Testzwecken. Später soll daraus ein
	 * <code> execute() <\code> o.ä. werden.
	 * 
	 * @param args
	 */
